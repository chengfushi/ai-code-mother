    ...
    <div class="container">
      ...
      <div class="quick-actions">
        <a-button
          ...
          @click="
            setPrompt(
              '创建一个个人博客网站，包含文章列表、详情页、分类标签、搜索功能和评论系统。使用简洁设计，支持响应式布局。',
            )
          "
          >个人博客网站</a-button
        >
        <a-button
          ...
          @click="
            setPrompt(
              '创建一个企业官网，包含公司介绍、产品展示、新闻资讯和联系我们页面。采用商务风格设计，支持响应式布局。',
            )
          "
          >企业官网</a-button
        >
        <a-button
          ...
          @click="
            setPrompt(
              '创建一个在线商城网站，包含商品展示、购物车和用户订单功能。使用现代化设计，支持商品搜索和筛选。',
            )
          "
          >在线商城</a-button
        >
        <a-button
          ...
          @click="
            setPrompt(
              '创建一个作品展示网站，包含作品画廊、项目详情、个人简介和联系方式页面。使用网格布局展示作品，支持图片查看功能。',
            )
          "
          >作品展示网站</a-button
        >
